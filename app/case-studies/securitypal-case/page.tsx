...
const cs = {
  client:   "SecurityPal",
  subject:  "Enterprise Narrative System",
  industry: "Security · Enterprise SaaS",
  type:     "Narrative Video System",
  year:     "2024",

  // ── HERO ──
  headline: "How SecurityPal collapsed 20 minutes of sales explanation into a 90-second buyer-clear narrative.",
  subhead:  "An enterprise narrative video built for decks, homepage, and pipeline — designed to make a complex security workflow obvious before the demo even starts.",

  // ── EXECUTIVE OVERVIEW ──
  overview:
    "SecurityPal's sales team was spending 20+ minutes on every call just explaining the core process. We built a 90-second narrative video that did that job for them — deployed across enterprise pipeline and reducing pre-demo explanation load from day one.",

  // ── SITUATION ──
  situation:
    "SecurityPal sells an enterprise-grade security review workflow to companies navigating complex procurement cycles. The product is genuinely powerful — but it involves multiple stakeholders, several stages, and a level of operational depth that's hard to convey in a first conversation. Their sales team was carrying that entire burden in real time.",

  // ── CHALLENGE ──
  challengeIntro:
    "The problem wasn't that buyers didn't eventually understand SecurityPal. The problem was how long it took — and how much it depended on the right person saying the right thing at the right moment.",
  challengePoints: [
    "Sales calls required 20+ minutes of upfront explanation before the product could speak for itself.",
    "Enterprise procurement cycles punish confusion — if the buyer can't 'see' the workflow early, they disengage.",
    "Existing materials (decks, one-pagers) described the product. None of them showed it.",
    "The video needed to work without a salesperson present — in decks, inboxes, and async review threads.",
  ],

  // ── INLINE PULL QUOTE ──
  pullQuote: {
    text:   "We needed buyers to understand the system before we ever got on a call. A video that could do that job — reliably, at scale — was the only answer.",
    person: "Team, SecurityPal",
  },

  // ── WHAT WE BUILT ──
  deliverables: [
    "90-second enterprise narrative video (primary pipeline asset)",
    "Structured for deck embed, homepage hero, and async send",
    "Workflow-first narrative — system clarity before feature detail",
  ],

  // ── MAIN VIDEO ──
  // Paste SecurityPal's YouTube/Vimeo embed URL when ready
  videoUrl:     "https://www.youtube.com/embed/azDJfHvwpEY?modestbranding=1&rel=0&showinfo=0&color=white",
  videoCaption: "SecurityPal — Enterprise Narrative System",

  // ── WHY IT WORKED ──
  whyItWorked: [
    { heading: "Workflow first, features second", body: "The narrative leads with how the system works end-to-end — not what each feature does. Buyers see the process before they see the product." },
    { heading: "Built for async review",          body: "Enterprise procurement happens in meetings the vendor isn't in. This video was designed to persuade without a presenter in the room." },
    { heading: "Multi-stakeholder clarity",       body: "Different people in a procurement cycle need different things. The script was structured so each stakeholder could extract their own signal." },
    { heading: "Reusable across pipeline",        body: "One asset deployed everywhere: sales decks, homepage, outbound sequences, and follow-up threads. No new production needed per channel." },
  ],

  // ── OUTCOME STATS ──
  outcomes: [
    { label: "Pre-demo load",  value: "Reduced"              },
    { label: "Deployed in",    value: "Enterprise pipeline"  },
    { label: "Use cases",      value: "Deck · Homepage · Outreach" },
    { label: "Turnaround",     value: "14-day sprint"        },
  ],

  // ── TESTIMONIAL VIDEO — paste embed URL when you have it ──
  testimonialVideoUrl: "",
  testimonialPerson:   "Team, SecurityPal",
  testimonialQuote:
    "The video did something our decks and one-pagers never could — it showed buyers the system working, not just described it. That shift changed how early-stage conversations felt.",
...
export default function SecurityPalCasePage() {
  ...
  return (
    <div style={{ background: "#000", minHeight: "100vh", color: "#f2f2f2", fontFamily: "var(--font-dm), system-ui, sans-serif" }}>
      ...
      <div className="cursor-light" id="cursorLightSP" aria-hidden="true" />
      ...
      <script dangerouslySetInnerHTML={{ __html: `
        (function(){
          var el = document.getElementById('cursorLightSP');
          if (!el) return;
