...
const cs = {
  ...
  // ── HERO ──
  headline: "How Aleph announced their Series B with a film that landed with investors, press, and future hires — in 7 days.",
  subhead:  "A funding announcement film built for authority and speed. Delivered in a single sprint, deployed across press, hiring, and investor audiences.",

  // ── EXECUTIVE OVERVIEW ──
  overview:
    "Aleph needed an investor-grade announcement film on a press-cycle timeline. We delivered a hero video in 7 days — structured to signal authority to three distinct audiences simultaneously: investors, press, and future hires.",

  // ── SITUATION ──
  situation:
    "Aleph is a B2B financial planning platform built for finance teams who've outgrown spreadsheets. When they closed their Series B, the announcement needed to do more than confirm the raise — it needed to signal a new chapter for every audience watching: investors validating their bet, press looking for the story, and candidates deciding whether to join.",

  // ── CHALLENGE ──
  challengeIntro:
    "The challenge wasn't the creative. It was the clock. Announcement films live and die by timing — and standard agency timelines wouldn't hold.",
  challengePoints: [
    "Press cycle was locked. The announcement date couldn't move — the video had to be ready.",
    "Three audiences, one film. Investors, press, and hiring candidates all needed to feel spoken to.",
    "Authority signal required. A generic 'we raised money' video would have undermined the round, not amplified it.",
    "No room for revision marathons. One tight feedback loop, fast decisions, and a delivery that landed clean.",
  ],

  // ── INLINE PULL QUOTE ──
  pullQuote: {
    text:   "We needed something that felt like Aleph — not a generic funding announcement. The video had to carry the weight of the moment.",
    person: "Team, Aleph",
  },

  // ── WHAT WE BUILT ──
  deliverables: [
    "Hero announcement film — structured for press, investor decks, and homepage",
    "Cutdown version for LinkedIn and outbound distribution",
    "Motion-designed title sequence and lower-thirds for authority framing",
  ],
  ...
  // ── WHY IT WORKED ──
  whyItWorked: [
    { heading: "7-day delivery",            body: "Scoped, scripted, produced, and delivered in a single sprint timed to the press cycle. No delays, no surprises." },
    { heading: "Three-audience structure",  body: "One film written to land differently for investors, press, and candidates — without feeling generic to any of them." },
    { heading: "Authority-first framing",   body: "The visual language and pacing were built to signal institutional confidence, not startup excitement." },
    { heading: "Press-ready from day one",  body: "File formats, aspect ratios, and caption files all prepped for direct distribution to media and social without post-processing." },
  ],

  // ── OUTCOME STATS ──
  outcomes: [
    { label: "Delivered in",  value: "7 days"              },
    { label: "Used in",       value: "Press + investor deck" },
    { label: "Also used for", value: "Hiring pipeline"     },
  ...
  testimonialQuote:
    "The turnaround was faster than we thought possible — and the result felt exactly right for the moment. It wasn't just a video. It was how we told the story of this round.",
...
export default function AlephCasePage() {
  ...
  return (
    <div style={{ background: "#000", minHeight: "100vh", color: "#f2f2f2", fontFamily: "var(--font-dm), system-ui, sans-serif" }}>
      ...
      <div className="cursor-light" id="cursorLightAleph" aria-hidden="true" />
      ...
      <script dangerouslySetInnerHTML={{ __html: `
        (function(){
          var el = document.getElementById('cursorLightAleph');
          if (!el) return;
